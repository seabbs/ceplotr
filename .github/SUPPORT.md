# Getting help with getTBinR

Thanks for using getTBinR. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/seabbs/ceplotr/issues) to make sure the 
